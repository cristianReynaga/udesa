...
![alt text](/assets/images/coordenadas.png "Sistemas de coordenadas en dos y tres dimensiones")  
...
**Ejemplo. Punto pivot en distintas ubicaciones locales..**  
En este ejemplo se aplica la misma rotación a dos rectángulos iguales pero con distintos puntos pivot para mostrar las diferencias en las coordenadas locales.   
...
### Parte 2: Coordenadas y posiciones en video 
...
### Parte 3: Sonido, espacio y tiempo 
