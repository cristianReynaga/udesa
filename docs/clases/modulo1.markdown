...
La mejor forma de conocer nuestros assets es visualizar sus Propiedades una vez importados en Adobe Premiere. Tenemos que conocer el formato, resolución y cuadros por segundo de cada uno de ellos para elegir la mejor configuración para nuestra secuencia.  
...
**Paso 3. El tratamiento de nuestra pieza.**
...
[Ver tutorial "Exportar en Premiere"](../tutoriales/PremierePro/exportar-premiere.html){:target="_blank"}  
